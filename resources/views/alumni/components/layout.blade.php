...
<body style="background-image: url('/asset/polka2.png')">
    <header>
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark-subtle ">
            ...
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-0 mt-lg-3">
                    ...
                    @include('alumni.components.sidemenu')
                    ...
                    <div class="dropdown py-2 mx-2 mt-2 d-block d-lg-none">
                        <a href="#" class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center"
                            ...
                            @include('alumni.components.imagename')
                        </a>
                        <ul class="dropdown-menu text-small shadow">
                            @include('alumni.components.usermenu')
                        </ul>
                    </div>
        ...
        <!-- Navbar -->
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-dark fixed-top text-white">
            <!-- Container wrapper -->
