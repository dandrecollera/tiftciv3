...
<div style="padding: 0px 20px 0px 10px">
    <form action="/adminrealcurriculum_add_process" method="POST" target="_parent" enctype="multipart/form-data"
        class="was-validated">
        @csrf
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <button type="submit" class="btn btn-primary float-end">Add Curriculum</button>
                </div>
            </div>
        </div>
    </form>
