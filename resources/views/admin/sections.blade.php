        ...
        <div class="col ">
            <form method="get">
                <div class="input-group mb-3">
                    ...
                    @if (!empty($keyword))
                    <button onclick="location.href='./adminsection'" type="button" class="btn btn-dark"><i
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><span
                                class="{{ $orderbylist[$sort]['display'] == 'Strand' ? 'text-primary' : '' }}"><strong>Strand</strong>
                            </span>
                        </th>
                        <th scope="col"><span
...
<script type="text/javascript">
    ...
    $('.dcc-delete').on('click', function() {
        ...
        console.log(iid);
        $('#Email').html(iemail);
        $('#DeleteButton').prop('href', '/adminsection_delete_process?sid='+iid+'&'+iqstring);
    });
});
</script>
