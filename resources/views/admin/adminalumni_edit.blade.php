...
<div style="padding: 0px 20px 0px 10px">
    <form action="/adminalumni_edit_process" method="POST" target="_parent">
        @csrf
    ...
    <form action="/adminalumni_pass_process" method="POST" target="_parent" id="conpass">
        @csrf
        <div class="container-fluid mb-4">
    ...
    <form action="/adminalumni_image_process" method="post" target="_parent" enctype="multipart/form-data">
        @csrf
