...
<div style="padding: 0px 20px 0px 10px">
    <form action="/adminregistrar_edit_process" method="POST" target="_parent" class="was-validated">
        @csrf
    ...
    <form action="/adminregistrar_pass_process" method="POST" target="_parent" id="conpass">
        @csrf
        <div class="container-fluid mb-4">
    ...
    <form action="/adminregistrar_image_process" method="post" target="_parent" enctype="multipart/form-data">
        @csrf
