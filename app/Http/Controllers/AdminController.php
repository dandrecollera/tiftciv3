...
class AdminController extends Controller
{
    ...
    public function adminuser(Request $request)
    {
        ...
        if ($page < 2) {
            ...
            $urlvar = $qstring;
            $urlvar['page'] = $urlvar['page'] - 1; // current page minus 1 for prev
        ...
        if ($page >= $data['totalpages']) {
            ...
            $urlvar = $qstring;
            $urlvar['page'] = $data['totalpages']; //lastpage
            ...
            $urlvar = $qstring;
            $urlvar['page'] = $urlvar['page'] + 1; //nest page
    ...
    public function adminuser_add_process(Request $request)
    {
        ...
        return redirect($this->default_url_adminuser . '?n=1');
        die();
    }
