...
class StudentCashierController extends Controller
{
    ...
    public function studentcashier(Request $request){
        $data = array();
        ...
        return view('admin.studentcashier', $data);
    }

    public function studentcashierreport(Request $request){
        $data = array();
        $data['userinfo'] = $userinfo = $request->get('userinfo');
